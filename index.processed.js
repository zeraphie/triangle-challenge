...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _triangleTypeTests = __webpack_require__(328);

	var _triangleTypeTests2 = _interopRequireDefault(_triangleTypeTests);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	mocha.setup('bdd');

	(0, _triangleTypeTests2.default)();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.trianglesInvalid = exports.triangles = undefined;
	exports.default = triangleTypeTests;

	var _chai = __webpack_require__(329);
	...
	var triangles = exports.triangles = [{
	    triangle: [5, 5, 5],
	...
	var trianglesInvalid = exports.trianglesInvalid = [{
	    triangle: [1, 1, 10],
	...
	function triangleTypeTests() {
	    triangles.forEach(function (_ref) {
	        var triangle = _ref.triangle,
	            expected = _ref.expected;

	        describe('When TriangleType is called using "' + triangle.join(', ') + '" as sides', function () {
	            it('should return ' + expected, function () {
	                _chai.assert.equal(expected, new (Function.prototype.bind.apply(_TriangleType2.default, [null].concat(_toConsumableArray(triangle))))().getType());
	            });
	        });
	    });

	    trianglesInvalid.forEach(function (_ref2) {
...
/***/ (function(module, exports) {
	...
	var assert = exports.assert = chai.assert;
...
/***/ (function(module, exports) {
	...
	var TriangleType = function () {
	    function TriangleType(sideA, sideB, sideC) {
	        _classCallCheck(this, TriangleType);
	    ...
	    _createClass(TriangleType, [{
	        key: 'validateTriangle',
	        value: function validateTriangle() {
	            if (this.triangle.indexOf(undefined) > -1) {
	                throw new Error('Invalid Sides: All sides must be a defined');
	            }

	            if (this.triangle.some(function (side) {
	                return isNaN(side);
	            })) {
